...
class ProfileTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.profile = Profile(
            profile_pic='test.jpg', bio='Test bio', contact="987654321", user=self.user)
...
class ProjectTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.profile = Profile(profile_pic='test2.jpg',
                               bio='Biooo', contact="123456789", user=self.user)
        self.profile.save_profile()
        self.project = Project(title='title', image='image.jpg', description='Description',
                               link='https://www.testingapplication.com', profile=self.profile, user=self.user)
    ...
    def test_update_method(self):
        ...
        '''
        self.project.save_project()
        updated_project = Project.objects.filter(
            title='title').update(title='title2')
